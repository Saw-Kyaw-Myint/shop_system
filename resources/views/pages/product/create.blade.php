                                    ...
                                    <div class="card-body">
                                       ...
                                       <span class="error-message">{{ $message }}</span>                                         
                                        ...
                                        <div class="form-group">
                                          ...
                                          <select name="category" id="" class=" custom-select">
                                           ...
                                           <option value="{{ $category->id }}" {{ $category->id== old('category') ? 'selected' :'' }}>{{ $category->ctitle }}</option>
                                            @endforeach
                                          </select>
                                      ...
                                      @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="exampleInputPassword1" name="description" placeholder="Enter Description" rows="5">{{ old('description') }}</textarea>
                                        </div>
                                        @error('description')
                                          <span class="error-message">{{ $message }}</span>
                                        @enderror
