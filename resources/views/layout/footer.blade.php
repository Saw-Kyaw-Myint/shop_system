        ...
        <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
            <div class="row px-xl-5 pt-5">
                <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                    ...
                    <p class="mb-2"><i
                            class="fa fa-map-marker-alt text-primary mr-3"></i>{{ __('message.address') }}</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>sawkyaw@gmail.com</p>
                    <p class="mb-0"><i
                            class="fa fa-phone-alt text-primary mr-3"></i>{{ __('message.phone_number') }}</p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-5">
                            ...
                            <div class="d-flex flex-column justify-content-start">
                                ...
                                <a class="text-secondary mb-2" href="#"><i
                                        class="fa fa-angle-right mr-2"></i>{{ __('message.products') }}
                                    Shop</a>
                                ...
                                <a class="text-secondary" href="#"><i
                                        class="fa fa-angle-right mr-2"></i>{{ __('message.contact') }}</a>
                            </div>
                        </div>
                        <div class="col-md-4 mb-5">
                            ...
                            <div class="d-flex flex-column justify-content-start">
                                ...
                                <a class="text-secondary mb-2" href="#"><i
                                        class="fa fa-angle-right mr-2"></i>{{ __('message.home') }}</a>
                                <a class="text-secondary mb-2" href="#"><i
                                        class="fa fa-angle-right mr-2"></i>{{ __('message.product_detail') }}</a>
                                <a class="text-secondary" href="#"><i
                                        class="fa fa-angle-right mr-2"></i>{{ __('message.contact') }}</a>
                            </div>
                        </div>
                            ...
                            <form action="">
                                <div class="input-group">
                                    <input type="text" class="form-control"
                                        placeholder="{{ __('message.your_email') }}">
