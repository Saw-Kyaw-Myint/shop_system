                ...
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <button class="dropdown-item" type="button"><a href="{{ route('login.create') }}">Sign in</a>
                                </button>
                            <button class="dropdown-item" type="button"><a href="{{ route('register.create') }}">Sign up</a>
                                </button>
                        </div>
                    </div>
